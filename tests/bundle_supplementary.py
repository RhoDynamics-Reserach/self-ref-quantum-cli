...
def bundle_supplementary_materials():
    ...
    files_to_zip = [
        'setup.py',
        'README.md',
        os.path.join('src', 'rhodynamics', 'math_engine.py'),
        os.path.join('src', 'rhodynamics', 'agent_model.py'),
        os.path.join('src', 'rhodynamics', 'rag_engine.py'),
        os.path.join('src', 'rhodynamics', 'encoding.py'),
        os.path.join('src', 'rhodynamics', 'middleware.py'),
        os.path.join('src', 'rhodynamics', 'hardware_connector.py'),
        os.path.join('src', 'rhodynamics', 'config.json'),
        os.path.join('src', 'rhodynamics', '__init__.py'),
